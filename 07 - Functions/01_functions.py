...
# The manual approach is really tedious... And can lead users to making simple mistakes.
print("NOVEMBER FEVER IS HERE!")
print(
    "Pick and choose among four different discounted bundles, made in collaboration with Soul King!"
)
...
# Functions come in handy in such cases. Allows users to put code with a specific purpose into a single location.
...
print(
    greeting_msg()
)  # When function is executed; the 'return' value will be equal to the data type, in the current case it is a string; 'str'.
