...
# If the user has an integer; it needs to be cast into a string before being used.
...
# we were accessing the necessary dictionary within 'format'.
...
# Since we pass in the same dictionary twice, let's go ahead and polish our code for the sake of efficiency.
