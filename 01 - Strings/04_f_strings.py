# 'f strings' is relatively a recent functionality. Works only with python version 3.6 or above...
# Basicly the idea behind 'f strings' is to make string formating as simple as possible.
greeting = "Greetings dear customer"
statement = "Welcome to the world of the future!"

# Proper syntax: f'user_message'
# Instead of using '.format()' method, users can pass in the variables within the placeholders.
...
# like uppercasing the store statement part per se...
