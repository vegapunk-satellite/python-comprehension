...
# While looping through 1 to 10 and printing numbers of the output double digit(zero padded).
for i in range(1, 11):
...
# Putting in comma separators for larger numbers:
sentence_cs = "1 MB is equal to {:,} bytes".format(
    1000**2
)  #':,' for comma separating output
print(sentence_cs)
