...
from CompSci import find_index, test        # 'as' can be used to shorten functions just like modules
...
print(os.getcwd())          #'getcwd' function prints out the current working directory where the script is located
print(os.__file__)          # '__file__' function prints out the Standard Library file's location in the directory
#-------------------------------------------------------------------------------------
import antigravity
