...
print(dir(os))                 #Prints out all of the attributes and methods we can access to within this module
print(os.getcwd())             #Prints out the directory of current script

os.chdir('C:/Users/MSI/Desktop/Vega Records/my_modules')        #Changes the current directory to the desired address via the argument
...
print(os.stat('importing_modules.py').st_mtime)         #Returns the last modification time of that file
...
print(os.getcwd())
mod_time = os.stat('importing_modules.py').st_mtime             #We need to put the timestamp into a variable
print(datetime.fromtimestamp(mod_time))                         #And use that variable as an argument for 'datetime.fromtimestamp' function
#-------------------------------------------------------------------------------------
##Traversing the directory tree
import os

for dirpath, dirnames, filenames in os.walk(os.getcwd()):           #If the desired directory is not the current one we can pass a specific directory as a string to our argument
...
print(os.path.isdir('/Users/MSI'))              #Returns true if specific path is a directory, false if not
print(os.path.isfile('/Users/MSI'))             #Returns true if specific path is a file, false if not
