# Sets are basically unordered collections of values with no duplicates.
...
# Could be done with lists and tuples as well; but sets are more optimised for this feature...
