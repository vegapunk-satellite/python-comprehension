# Let us try out various list methods that available for users...
courses = ["History", "Math", "Physics", "CompSci"]

# Adding an item to our list:
# '.append()' method allows to add an item to the end of the list.
...
print(popped)
# In cases where list is used like a stack or a queue; '.pop()' method is extremely useful.
...
# Honorable Mentions(more built-in functionalities):
